...
var data = {
  nodes: [
    ...
    {id: 'hoge', label: {name: '改行にも\n対応したよ', color: '#bb036a', dx: -20, dy: -20}, style: {rx: 20, ry: 20, strokeWidth: 5, fillColor: "#3e3e3e"}},
  ...
  links: [
    ...
    {source: 'hoge', target: 'piyo', label: {name: 'yes', color: '#bb036a', dx: -20, dy: 30}, style: {color: '#bb036a'}},
